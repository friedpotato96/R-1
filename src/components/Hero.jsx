...
// main functions
    return (
        <div className="relative h-dvh w-screen overflow-x-hidden">
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-y-hidden rounded-lg bg-blue-75">
                <div>
                    <div
                ...
                <div className="absolute left-0 top-0 z-40 size-full">
                    <div className="mt-24 px-5 sm:px-10">
                        <h1 className="special-font hero-heading text-blue-100">redefin<b>e</b></h1>
                        <p className="mb-5 mx-w-64 font-robert-regular text-blue-100">pata nahi but this is very cool</p>
                        <Button
                            id="watch-trailer"
                            title="Watch Trailer"
